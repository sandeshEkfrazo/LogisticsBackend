...
class CustomUser(admin.ModelAdmin):
    ...
    list_display =['id','user_role_name','city','vehicle','first_name','last_name','mobile_number','company_name','email','on_going_ride','user_online_status','alternate_number','zip_code','address','adhar_card','reset_otp','profile_image_path','base64','adhar_card_front_side_img','adhar_card_front_side_img_path','adhar_card_back_side_img','adhar_card_back_side_img_path','pan_card','pan_image_path','pan_card_base64','whatsup_number', 'user_status', 'user_active_status']
