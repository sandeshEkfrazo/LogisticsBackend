    ...
    def get(self, request):
        if request.query_params:
            ...
            if driver_obj[0]['owner_id'] == request.query_params['user_id']:
                ...
                print("is subscribed ===>>>" ,Vehicle_Subscription.objects.filter(Q(vehicle_id_id=vehcile_id) & Q(type_of_service='pre-paid') | Q(is_amount_paid=True) & Q(is_expired=True)).exists())
