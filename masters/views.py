...
class BookingDistanceApiView(APIView):
    ...
    def post(self, request):
        ...
        if not (intial_km_value and incremented_km_value and last_km_value and description  and intial_search_time and incremented_search_time and last_search_time):
        ...
        try:
            ...
            distance = BookingDistance.objects.create(intial_km_value=intial_km_value,
    ...
    def put(self, request, pk):
        ...
        if intial_km_value is not None:
            distance.intial_km_value = intial_km_value
        ...
        if intial_search_time is not None:  
            distance.intial_search_time = intial_search_time 
